...
public abstract class AndroidGame extends Activity implements Game, BeaconConsumer {
    ...
    Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            String[] id_beacons = new String[5];
            ...
            GameScreen.getFingerprinting().setValReceived(mapAllBeacons);

            auxiliar.Pair pairGasit = GameScreen.getFingerprinting().start();

            GameScreen.setpGasit(pairGasit);

        }
    };
    RepeatingTask task = new RepeatingTask(runnable, 2000);
